...
return new class extends Migration
{
    public function up()
    {
        Schema::create('events', function (Blueprint $table) {
            ...
            $table->string('aldimark_requirement')->nullable();
            ...
            $table->string('maintenance_requirement')->nullable();
            ...
            $table->string('general_services_requirement')->nullable();
            ...
            $table->string('systems_requirement')->nullable();
            ...
            $table->string('purchases_requirement')->nullable();
            ...
            $table->string('communications_coverage')->nullable();
