{{-- resources/views/kpis/enfermeria/index.blade.php --}}
...
<!-- Sección de análisis estadístico y gráfica -->
<div class="card mt-3">
    <div class="card-header">
...
@section('js')
<!-- jQuery, DataTables, Chart.js y SweetAlert2 -->
...
<script>
    $(document).ready(function() {
        // Inicializar DataTables para la tabla de KPIs
        $('#kpiTable').DataTable();

        // Inicializar la gráfica de barras con Chart.js
