{{-- resources/views/kpis/rrhh/index.blade.php --}}
@extends('adminlte::page')

@section('title', 'Ver KPI - Recursos Humanos')
        ...
        <table id="kpiTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('kpis.rrhh.show', $kpi->id) }}" class="btn btn-sm btn-info">Ver</a>
                        <a href="{{ route('kpis.rrhh.edit', $kpi->id) }}" class="btn btn-sm btn-primary">Editar</a>
