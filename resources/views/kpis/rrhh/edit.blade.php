...
@section('title', 'Editar KPI - Recursos Humanos')

@section('content_header')
    <h1>Editar KPI - Recursos Humanos</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('kpis.rrhh.update', $kpi->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="measurement_date" id="measurement_date" 
                               class="form-control" value="{{ old('measurement_date', $kpi->measurement_date) }}" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" min="0" max="100" name="percentage" 
                               id="percentage" class="form-control" value="{{ old('percentage', $kpi->percentage) }}" required>
                    </div>
                </div>
            </div>
