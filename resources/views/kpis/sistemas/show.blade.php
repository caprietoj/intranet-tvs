{{-- resources/views/kpis/sistemas/show.blade.php --}}
@extends('adminlte::page')

@section('title', 'Detalle del KPI - Sistemas')

@section('content_header')
    <h1>Detalle del KPI - Sistemas</h1>
@stop
...
<div class="card">
    ...
    <div class="card-footer">
        <a href="{{ route('kpis.sistemas.edit', $kpi->id) }}" class="btn btn-primary">Editar</a>
        <a href="{{ route('kpis.sistemas.index') }}" class="btn btn-secondary">Volver</a>
    </div>
</div>
@stop
