{{-- resources/views/threshold/sistemas/create.blade.php --}}
@extends('adminlte::page')

@section('title', 'Crear Threshold - Sistemas')

@section('content_header')
    <h1>Crear Configuración de Threshold - Sistemas</h1>
@stop

@section('content')
<div class="card">
    <div class="card-body">
        <form action="{{ route('umbral.sistemas.store') }}" method="POST">
            @csrf
