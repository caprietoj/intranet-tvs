{{-- resources/views/threshold/sistemas/index.blade.php --}}
@extends('adminlte::page')

@section('title', 'Ver Umbrales - Sistemas')

@section('content_header')
    <h1>Umbrales Configurados - Sistemas</h1>
@stop
        ...
        <table id="thresholdTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('umbral.sistemas.edit', $threshold->id) }}" class="btn btn-sm btn-primary">Editar</a>
    ...
    $('.delete-threshold').click(function(){
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                $.ajax({
                    url: '/sistemas/umbral/' + thresholdId,
                    type: 'DELETE',
